...
{
	//カメラ
	Math::Matrix transMat = Math::Matrix::CreateTranslation(0, 0, -8.0f);
	Math::Matrix cameraWorldMat = transMat;

	m_spCamera->SetCameraMatrix(cameraWorldMat);
